...
export default function Register({ open, onClose }) {
  ...
  const passwordValidation = () => {
    ...
    if (pass1.length >= 8) {
      document
        .getElementById("pass-length")
        .classList.replace("pass-fail", "pass-success");
      passRequirementsAmount++;
    } else
      document
        .getElementById("pass-length")
        .classList.replace("pass-success", "pass-fail");
    for (let i = 0; i < pass1.length; i++) {
      if (!isNaN(pass1.charAt(i))) numberAmount++;
      else if (pass1.charAt(i) === pass1.charAt(i).toUpperCase())
        upperCaseAmount++;
    }
    ///password uppercase
    if (upperCaseAmount >= 1) {
      document
        .getElementById("pass-letters")
        .classList.replace("pass-fail", "pass-success");
      passRequirementsAmount++;
    } else
      document
    ...
    <div className="register-modal">
      ...
      <div className="register">
        ...
        <div className="password-requirements">
          ...
          <ul>
            <li className="pass-fail" id="pass-length">
              At least 8 characters
            </li>
            <li className="pass-fail" id="pass-letters">
              A mixture of uppercase and lowercase letter
            </li>
            <li className="pass-fail" id="pass-numbers">
              A mixture of letters and numbers
            </li>
            <li className="pass-fail" id="pass-match">
