		...
		<div className={styles.containerDetail}>
			...
			<div className={styles.principalSectionInterno}>
				<div className={styles.internoimg}>
					...
					<img
						src={detailObra.photos[bigImage].url}
						alt="img"
						className={styles.photoPaintingDetail}
					/>
				</div>
					...
					<div className={styles.divContainerInfoObra}>
						<div className={styles.divContainerTitleFav}>
							<div className={styles.containerInfoObra}>
								...
								<span className={styles.spanTech}>{detailObra.techniques[0].name}</span>
							...
							{user.role === "admin" ? (
								<div className={styles.divContainerButtonAvailable}>
									...
									<button onClick={() => handleAvailable(id, detailObra.isAvailable)}>
										{detailObra.isAvailable ? (
											<p className={styles.pTextPaintingforSale}>Take from sale</p>
										) : (
