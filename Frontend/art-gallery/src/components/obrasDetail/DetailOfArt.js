...
export const DetailOfArt = () => {
  ...
  return (
    <div className={styles.containerDetail}>
      <header className={styles.principalHeader}></header>
      <section className={styles.principalSection}>
        <div className={styles.principalSectionInterno}>
          <CarsDetailObra title={obra[0].title} img={obra[0].image} />
          <CarsDetailObra description={obra} />
      ...
      <footer className={styles.principalFooter}></footer>
    </div>
  );
};
