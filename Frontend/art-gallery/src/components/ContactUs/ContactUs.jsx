    ...
    return (
      ...
      <div className="contact-box">
          ...
          <div className="data-box">
                ...
                <div>
                <i onClick={()=>handleForm('user')} className="fa fa-user-o" aria-hidden="true">

                  <p onClick={()=>handleForm('user')}>If you are a customer</p>
                </i>

                <i onClick={()=>handleForm('art')} className="fa fa-paint-brush" aria-hidden="true">
              ...
              <div className="maps-box">
                  ...
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3349023.554146793!2d-69.86920693750001!3d-34.943302200000005!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x967811ea685ec013%3A0x39f09984ee7317ee!2sUbUrey%20Espacio%20de%20Arte%20Contemporaneo!5e0!3m2!1ses!2smx!4v1646394205800!5m2!1ses!2smx" width="800px" height="400px"   loading="lazy"></iframe>
              </div>           
