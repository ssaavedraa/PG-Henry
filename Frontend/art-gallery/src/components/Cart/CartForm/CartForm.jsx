          ...
          <div className="divContainerInputsFormCart">
            ...
            <div className="divContainerNameLastCart">
              <div className="divNameLastCart">
                <label
                  className={
                    errorState.error.firstName === "Name require"
                      ? "activeLabel"
                      : ""
                  }
                >
            ...
            <label
              className={
                errorState.error.telephone === "phone invalid"
                  ? "activeLabel"
                  : ""
              }
            >
            ...
            <label
              className={
                errorState.error.postCode === "postCode require"
                  ? "activeLabel"
                  : ""
              }
            >
            ...
            <label
              className={
                errorState.error.city === "city require" ? "activeLabel" : ""
              }
            >
              City
            </label>
            <input
              className={
                errorState.error.city === "city require" ? "activeError" : ""
              }
              type="text"
              name="city"
              value={info.city}
            ...
            <label
              className={
                errorState.error.street === "street require"
                  ? "activeLabel"
                  : ""
              }
            >
